...
function DeniedListForm()
{
  ...
  print("<INPUT TYPE=\"HIDDEN\" NAME=\"execute\" id=function value=\"deniedlistform\">\n");
  ...
  print("<INPUT TYPE=\"BUTTON\" value=\"$redir_openurlbase8\"  OnClick=AddURL(ADDURL)>\n");
  print("</FORM>\n");
...
function AddDeniedListForm()
{
  ...
  print("<TD>\n");
  print("<INPUT TYPE=\"HIDDEN\" NAME=\"type\" id=type value=\"denied\">\n");
...
function DeniedListTray()
{
  ...
  print("<SCRIPT>\n");
     print("        parent.basefrm.location.href=\"main.php?show=exe&function=deniedlistform&id=$id\";\n");
  print("</SCRIPT> \n");
  ...
  if($SAMSConf->access==2)
    {
      ...
      ExecuteFunctions("./src", "deniedbuttom","1");
