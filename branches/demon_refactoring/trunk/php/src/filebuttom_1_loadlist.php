...
function LoadFileListForm()
{
  ...
  print("<FORM NAME=\"LOADBACKUP\" ENCTYPE=\"multipart/form-data\" ACTION=\"main.php?show=exe&function=loadfilelist&filename=filebuttom_1_loadlist.php&id=$id&type=file&execute=filelisttray \" METHOD=POST>\n");
...
GraphButton("main.php?show=exe&function=loadfilelistform&filename=filebuttom_1_loadlist.php&id=$id","basefrm","import_32.jpg","import_48.jpg","$redir_redirtray2 ");
	}
