...
function AllUsersForm()
{
  ...
  //$result=mysql_query("SELECT squidusers.*,groups.nick AS gnick FROM squidusers LEFT JOIN squidctrl.groups ON groups.name=squidusers.group ORDER BY squidusers.group,squidusers.nick");
 $result=mysql_query("SELECT squidusers.*,groups.nick AS gnick, shablons.period, year(shablons.clrdate) as year, month(shablons.clrdate) as month, dayofmonth(shablons.clrdate) as day FROM squidusers LEFT JOIN squidctrl.groups ON groups.name=squidusers.group LEFT JOIN squidctrl.shablons ON squidusers.shablon=shablons.name ORDER BY squidusers.group,squidusers.nick");
