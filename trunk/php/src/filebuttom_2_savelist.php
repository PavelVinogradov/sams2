...
function filebuttom_2_savelist($access)
{
  global $SAMSConf;
   ...
   if($SAMSConf->access==2)
    {
       ...
       GraphButton("main.php?show=exe&function=savefilelist&filename=filebuttom_2_savelist.php&id=$id","basefrm","export_32.jpg","export_48.jpg","$redir_redirtray3");
	}
