...
function LoadAllowListForm()
{
  ...
  print("<FORM NAME=\"LOADBACKUP\" ENCTYPE=\"multipart/form-data\" ACTION=\"main.php?show=exe&function=loadallowlist&filename=allowbuttom_1_loadlist.php&id=$id&type=allow&execute=allowlisttray \" METHOD=POST>\n");
...
function allowbuttom_1_loadlist($access)
{
  global $SAMSConf;
...
GraphButton("main.php?show=exe&function=loadallowlistform&filename=allowbuttom_1_loadlist.php&id=$id","basefrm","import_32.jpg","import_48.jpg","$redir_redirtray2 ");
	}
