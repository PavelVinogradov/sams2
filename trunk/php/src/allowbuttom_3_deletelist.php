...
function allowbuttom_3_deletelist($access)
{
  global $SAMSConf;
  ...
  if($SAMSConf->access==2)
    {
       ...
       print("  if(value==true) \n");
       print("     {\n");
       print("        parent.basefrm.location.href=\"main.php?show=exe&function=deletelist&filename=urllistfunction.php&id=$id&execute=addallowlistform\";\n");
       print("     }\n");
       print("}\n");
       print("</SCRIPT> \n");
