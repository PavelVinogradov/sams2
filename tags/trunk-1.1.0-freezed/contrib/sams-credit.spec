...
%if "%{samsrelease}" == "credit"
install -m 644 $RPM_SOURCE_DIR/credit_alarm.gif $RPM_BUILD_ROOT%{_datadir}/sams/icon/classic/credit_alarm.gif
install -m 644 $RPM_SOURCE_DIR/credit-change.sql $RPM_BUILD_ROOT%{_datadir}/sams/data/credit-change.sql
%endif
